...
!(function () {
  function e(e, t) {
    return (
      (t || '') + ' (SystemJS Error#' + e + ' https://github.com/systemjs/systemjs/blob/main/docs/errors.md#' + e + ')'
    );
  }
  function t(e, t) {
    if ((-1 !== e.indexOf('\\') && (e = e.replace(j, '/')), '/' === e[0] && '/' === e[1]))
    ...
    var c = Promise.resolve()
        ...
        .then(
          function (r) {
            ...
            return ((o.e = i.execute || function () {}), [r[0], i.setters || [], r[2] || []]);
          },
          function (e) {
    ...
    [].forEach.call(document.querySelectorAll('script'), function (t) {
      if (!t.sp)
        if ('systemjs-module' === t.type) {
          ...
          t.sp = !0;
          var r = t.src
            ? (System.fetch || fetch)(t.src, { integrity: t.integrity, priority: t.fetchPriority, passThrough: !0 })
                .then(function (e) {
  ...
  var C,
    R,
    W = Promise.resolve(),
    N = { imports: {}, scopes: {}, depcache: {}, integrity: {} },
    T = S;
  if (
    ...
    S && (m(), window.addEventListener('DOMContentLoaded', m)),
        ...
        return new Promise(function (o, s) {
          (r.addEventListener('error', function () {
            ...
            r.addEventListener('load', function () {
              if ((document.head.removeChild(r), J === t)) s(_);
              else {
  ...
  ((I.instantiate = function (t, n, r) {
    ...
    return this.shouldFetch(t, n, r)
      ? this.fetch(t, { credentials: 'same-origin', integrity: N.integrity[t], meta: r }).then(function (r) {
  ...
  ((I.get = function (e) {
    ...
    (I.set = function (t, n) {
      ...
      q && 'Module' === n[q]
        ? (r = n)
        : ((r = Object.assign(Object.create(null), n)), q && Object.defineProperty(r, q, { value: 'Module' }));
