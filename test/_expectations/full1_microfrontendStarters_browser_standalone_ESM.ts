...
export async function startMyFirstMicrofrontend(
  ...
  try {
    ...
    console.error(
      '[OpenMicrofrontends] Loading assets of Microfrontend "My First Microfrontend" failed!',
      e,
    );
    return;
  }
  ...
  const renderFunction =
    exportedModules.find((m) => "startMyFirstMicrofrontend" in m)?.[
      "startMyFirstMicrofrontend"
    ] || (window as any)["startMyFirstMicrofrontend"];
  if (!renderFunction) {
    console.error(
      '[OpenMicrofrontends] Render function of Microfrontend "My First Microfrontend" not found!',
    );
    return;
  }
  ...
  return {
    close: async () => {
      console.info(
        '[OpenMicrofrontends] Closing Microfrontend "My First Microfrontend"',
      );
